...
EXTENSION_NAME=OML_PARSER
EXTENSION_FLAGS=\
-DDUCKDB_EXTENSION_NAMES="oml_parser" \
...
#### Main build
# For regular CLI build, we link the oml_parser extension directly into the DuckDB executable
...
#### Client tests
DEBUG_EXT_PATH='$(PROJ_DIR)build/debug/extension/oml_parser/oml_parser.duckdb_extension'
RELEASE_EXT_PATH='$(PROJ_DIR)build/release/extension/oml_parser/oml_parser.duckdb_extension'
